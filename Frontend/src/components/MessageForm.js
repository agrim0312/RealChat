        ...
        <>
                            ...
                            <div className={sender?.email == user?.email ? "message" : "incoming-message"} key={msgIdx}>
                                <div className='message-inner'>
                                    <div className='d-flex align-items-center mb-3'>
                                        <img src={sender.picture} style={{width : 28 , height :28 , objectFit: 'cover', borderRadius: "50%" , marginRight: 10}} />
            ...
            <Form onSubmit={handleSubmit}>
                <Row>
                    ...
                    <Col md={1}>
                        <button variant="primary" type="submit" style={{ width: '70%', backgroundColor: 'orange', height: '90%' }} disabled={!user}>
